...
basepath = 'G:/Mi unidad/2023/Doctorado/60367-Tutela/Paper Dataset/SAR_Toronto/' #Path of folder where the image is locatedrutaimg1 = 'prom10.tiff'
...
GTpath = 'AverageGT.tiff' #Image obtained by averaging several images with Generate_GTruth.py
